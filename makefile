...
vente.o: vente.cpp vente.hpp date.hpp article.hpp article_vendu.hpp reference_article.hpp article_vendu_affichage.hpp
article_vendu_affichage.o: article_vendu_affichage.cpp article_vendu_affichage.hpp article_vendu.hpp reference_article.hpp
...
libqlot.a: magasin.o date.o pourcentage.o reference_article.o article.o stock.o article_vendu.o vente.o historique_ventes.o article_affichage.o articles_existants.o article_stock.o article_vendu.o article_vendu_affichage.o es.o | lib_dir
	ar -crv $(PATH_LIB)/libqlot.a $(PATH_OBJ)/magasin.o $(PATH_OBJ)/date.o $(PATH_OBJ)/pourcentage.o $(PATH_OBJ)/reference_article.o $(PATH_OBJ)/article.o $(PATH_OBJ)/stock.o $(PATH_OBJ)/article_vendu.o $(PATH_OBJ)/vente.o $(PATH_OBJ)/historique_ventes.o $(PATH_OBJ)/article_affichage.o $(PATH_OBJ)/articles_existants.o $(PATH_OBJ)/article_stock.o $(PATH_OBJ)/article_vendu_affichage.o $(PATH_OBJ)/es.o
